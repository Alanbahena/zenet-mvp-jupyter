...
| `architecture-readiness-kpis.md` exists with summary and links to full spec | ✅ | Schema, dimensions, scoring, UX guidance; references .taskmaster/docs/subtask-2.7-plan.md and readiness-scorecard-ux.md. |
